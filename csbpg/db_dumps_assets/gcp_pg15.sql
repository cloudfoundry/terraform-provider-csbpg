...
-- pg_dumpall --if-exists --clean --no-role-passwords --exclude-database cloudsqladmin -h SOME_HOST -U SOME_USER -f gcp_pg15.sql
-- sed -i 's/SOME_USER/testuser/' gcp_pg15.sql
--
...
GRANT pg_checkpoint TO cloudsqlsuperuser WITH ADMIN OPTION GRANTED BY cloudsqladmin;
